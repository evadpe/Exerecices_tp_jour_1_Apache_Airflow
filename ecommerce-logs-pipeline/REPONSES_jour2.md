...
Questions exercice supplémentaires : 
Exercice 1 : Pourquoi mode="reschedule" est recommandé en production avec CeleryExecutor ?
- Avec CeleryExecutor chaque worker a un nombre limité de slotsd onc si on a 32 sensors en mode poke qui attendent le worker va être plein et plus aucune tâche peuvent se lancer. 